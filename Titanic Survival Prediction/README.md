...
#### Sibsp vs Survived:
        SibSp is the abbreviated form of Sibling and Spouse.It was observed that Those with 1 Sibling or just their Spouse had a higher chance if Survival.
#### Age vs Survived:
        People who were of ages 20-40 have a higher chance of Survival
#### Family vs Survived:
        Families with 3 members have the highest chances of survival
#### Name_Title vs Survived:
         People with the Name_Titles: 'Sir', 'Countess' and 'Lady' have survived.Additionally, most of the people with the honorifics: 'Mrs', 'Ms', 'Master' have a higher Survival Rate.Thus we infer that, Women, Children and Nobles have a higher Survival Rate
## Encoding:
...
###### Accuracy:
    ...
    2. Accuracy Score of Logistic Regression after Hypyer Parameter Tuning stands at: 95.2%
